...
import {
    conformidadSchema,
    conformidadTrazabilidadSchema,
    catalogoNombreSchema,
    catalogoOrdenSchema,
    catalogoNumeroSchema,
    grupoConformidadSchema,
} from '../schemas/conformidadSchema.js';
...
router.post('/estados', checkPermission('conformidades', 'WRITE'), validate(catalogoOrdenSchema), crearEstado);
router.patch('/estados/:id', checkPermission('conformidades', 'WRITE'), validate(catalogoOrdenSchema), actualizarEstado);
...
router.post('/entidades', checkPermission('conformidades', 'WRITE'), validate(catalogoNombreSchema), crearEntidad);
router.patch('/entidades/:id', checkPermission('conformidades', 'WRITE'), validate(catalogoNombreSchema), actualizarEntidad);
...
router.post('/proyectos', checkPermission('conformidades', 'WRITE'), validate(catalogoNombreSchema), crearProyecto);
router.patch('/proyectos/:id', checkPermission('conformidades', 'WRITE'), validate(catalogoNombreSchema), actualizarProyecto);
...
router.post('/contratos', checkPermission('conformidades', 'WRITE'), validate(catalogoNumeroSchema), crearContrato);
router.patch('/contratos/:id', checkPermission('conformidades', 'WRITE'), validate(catalogoNumeroSchema), actualizarContrato);
router.delete('/contratos/:id', checkPermission('conformidades', 'WRITE'), eliminarContrato);

router.post('/:id/grupos', checkPermission('conformidades', 'WRITE'), validate(grupoConformidadSchema), asignarGrupoAConformidad);
