...
router.post('/minutas', authenticateToken, checkPermission('contratos', 'WRITE'), crearMinuta);
router.patch('/minutas/:id', authenticateToken, checkPermission('contratos', 'WRITE'), actualizarMinuta);
...
router.post('/auditorias', authenticateToken, checkPermission('contratos', 'WRITE'), crearAuditoria);
router.post('/auditorias/:id/regenerar-prompt', authenticateToken, checkPermission('contratos', 'WRITE'), regenerarPrompt);
router.get('/auditorias/:id/diff', authenticateToken, checkPermission('contratos', 'READ'), obtenerDiff);
router.patch('/auditorias/:id', authenticateToken, checkPermission('contratos', 'WRITE'), actualizarAuditoria);
